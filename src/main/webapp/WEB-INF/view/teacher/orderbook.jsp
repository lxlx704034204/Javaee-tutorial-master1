...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="row" id="addedBookContainer">
            <jsp:include page="${pageContext.request.contextPath}/orderbook.do/orderbook_added.view"></jsp:include>
        </div>
        <div>
            <h1 class="page-header">添加教材</h1>
        </div>
        <jsp:include page="${pageContext.request.contextPath}/orderbook.do/orderbook_add.view"></jsp:include>
                    <!-- "/view/teacher/orderbook.do/orderbook_add.jsp" -->
    </div>
